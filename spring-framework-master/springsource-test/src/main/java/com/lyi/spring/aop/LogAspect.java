...
public class LogAspect {
	...
	//前置通知  增强方法/增强器
	@Before("execution(* com.lyi.spring.aop.HelloService.sayHello(..))")
	...
	//返回通知
	@AfterReturning(value = "execution(* com.lyi.spring.aop.HelloService.sayHello(..))",returning = "result")
	...
	//后置通知
	@After("execution(* com.lyi.spring.aop.HelloService.sayHello(..))")
	...
	//异常
	@AfterThrowing(value = "execution(* com.lyi.spring.aop.HelloService.sayHello(..))",throwing = "e")
